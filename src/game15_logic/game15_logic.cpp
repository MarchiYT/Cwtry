...
int Ship_placement(int b[10 + 2][10 + 2])
{
    ...
    while (l < 1) {
        int i = rand() % 10 + 1; int j = rand() % 10 + 1;
        b[i][j] = 1;
        if (i >= 4 && i <= 7 && j >= 4 && j <= 7) {
...
int timer() {
    ...
    if (clock() > start_time + 1.2 * CLOCKS_PER_SEC + 0.1) {
        return 1;
    }
    return 0;
}
...
int zeroGrid(int Gridp[10 + 2][10 + 2], int Gridc[10 + 2][10 + 2]) {
    ...
    for (int x = 0; x < 10 + 2; x++) {
        if (Gridp[x][0] != -1 || Gridc[x][0] != -1 || Gridp[x][10 + 1] != -1 || Gridc[x][10 + 1] != -1) {
            return 1;
        }
    }
    ...
    for (int y = 0; y < 10 + 2; y++) {
        if (Gridp[0][y] != -1 || Gridc[0][y] != -1 || Gridp[10 + 1][y] != -1 || Gridc[10 + 1][y] != -1) {
            return 1;
        }
    }
    return 0;
...
int aroundHit(int Grid[10 + 2][10 + 2], int x, int y) {
    if (x > 10 + 1 || y > 10 + 1 || x < 1 || y < 1) {
        return 1;
    }
    Grid[x][y] = 4;
    if (Grid[x + 1][y] == 0 && (x + 1) >= 1 && (x + 1) < 10 + 1 && y >= 1 && y < 10 + 1) {
        Grid[x + 1][y] = 2;
        if (x + 1 >= 10 + 2) {
            return 1;
        }
    ...
    if (Grid[x][y + 1] == 0 && x >= 1 && x < 10 + 1 && (y + 1) >= 1 && (y + 1) < 10 + 1) {
        Grid[x][y + 1] = 2;
        if (y + 1 >= 10 + 2) {
            return 1;
        }
    ...
    if (Grid[x + 1][y + 1] == 0 && (x + 1) >= 1 && (x + 1) < 10 + 1 && (y + 1) >= 1 && (y + 1) < 10 + 1) {
        Grid[x + 1][y + 1] = 2;
        if (x + 1 >= 10 + 2 || y + 1 >= 10 + 2) {
            return 1;
        }
    }
    if (Grid[x - 1][y - 1] == 0 && (x - 1) >= 1 && (x - 1) < 10 + 1 && (y - 1) >= 1 && (y - 1) < 10 + 1) {
